...
public class ParkingService {
    ...
    public ParkingSpot getNextParkingNumberIfAvailable(){
        System.out.println("Vérification du type de véhicule");
        int parkingNumber = 0;
        ParkingSpot parkingSpot = null;
        try{
            ParkingType parkingType = getVehichleType();
            System.out.println("Type de véhicule sélectionné : " + parkingType);
            ...
            System.out.println("Erreur dans le type de véhicule : " + ie.getMessage());
